...
namespace Layer_2_Common.Type
{
    public class CRUDmessages
    {
        ...
        public static void QueryIsEmpty()
        {
            ...
            message = "Sorgu Boş Sonuç Döndürdü.";
            MessageBox.Show(message, "Uyarı", MessageBoxButton.OK, MessageBoxImage.Information);
        }
        ...
        public static bool InsertOnayMessage(string message)
        {
            MessageBoxResult result = MessageBox.Show(message, "Kayıt İşlemi", MessageBoxButton.YesNo, MessageBoxImage.Question);
