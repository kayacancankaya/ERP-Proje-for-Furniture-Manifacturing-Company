    ...
    public partial class Popup_Irsaliye_Cari_Secim : Window
    {
        ...
        private void btn_tedarik_cari_listele_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                cls_cari_tedarik_cari.SipariseCariBaglaCollection = cls_cari_tedarik_cari.PopulateSipariseCariBaglaTeslimCari(txt_tedarik_cari_kodu.Text, txt_tedarik_cari_adi.Text);
