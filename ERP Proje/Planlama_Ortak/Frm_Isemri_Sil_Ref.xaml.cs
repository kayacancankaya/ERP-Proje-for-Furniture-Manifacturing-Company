...
namespace Layer_UI.Planlama_Ortak
{
    ...
    /// </summary>
    public partial class Frm_Isemri_Sil_Ref : Window
    {
        public Frm_Isemri_Sil_Ref()
        {
        ...
        private void btn_listele_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                isemriCollection = isemri.PopulateIsemriGeriAlList(restrictionPairs, true);
        ...
        private async void btn_isemri_geri_al_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                variables.ResultInt = await isemri.IsemriGeriAlAsync(gerialCollection, true);
                ...
                switch (variables.ResultInt)
                {
                    case -1:
                        ...
                        return;
                    case -2:
                        CRUDmessages.GeneralFailureMessageCustomMessage("Silme İşlemi Esnasında Problem İle Karşılaşıldı.");
                        txt_please_wait.Visibility = Visibility.Collapsed;
                        return;
                    case 2:
