        ...
        private void btn_kaydet_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (ozellikTip == "Ürün Grup")
                {
                    ...
                    if (txt_kod.Text.Length > 2)
                    { CRUDmessages.GeneralFailureMessageCustomMessage("Kod 2 Karakterden Büyük Olamaz"); return; }
                    if (txt_kod.Text.Length == 1)
                        txt_kod.Text.PadLeft(2, '0');
                ...
                if (ozellikTip == "Model")
                {
                    if (txt_kod.Text.Length > 3)
                    { CRUDmessages.GeneralFailureMessageCustomMessage("Kod 3 Karakterden Büyük Olamaz"); return; }
                    if (txt_kod.Text.Length < 3)
                        txt_kod.Text.PadLeft(3, '0');
