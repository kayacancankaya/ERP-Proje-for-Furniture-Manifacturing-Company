    ...
    public partial class Frm_Koli_Uyarla : Window
    {
        ...
        private void btn_recete_listele_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                { CRUDmessages.GeneralFailureMessageCustomMessage("Eklemek İstediğiniz Ölçülere Ait Stok Kodu Bulunmakta! \n" + arge.ArgeCollection.Select(a => a.YariMamulKodu).FirstOrDefault()); Mouse.OverrideCursor = null; return; }
                ...
                if (arge.ArgeCollection.Select(a => a.HamKodu).FirstOrDefault() == "Boş Sonuç")
                {
                    ...
                    arge.HamKodu = "HM000011041";
                    arge.HamAdi = "KARTON KSSST BASKISIZ E+B DALGA 135KL135FL80FL135FL135KL";

                    //eski mantıkta ene göre stok kartı açılıyordu geri dönülmesi ihtimaline karşı yorum olarak bırakıldı.
                    //if (arge.En < 1100)
        ...
        private void btn_stok_kaydet_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                if (arge.IfStokKoduExists(arge.StokKodu))
