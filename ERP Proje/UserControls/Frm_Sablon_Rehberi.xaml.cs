...
{
    /// <summary>
    /// Interaction logic for Frm_Sablon_Rehberi.xaml
    /// </summary>
    public partial class Frm_Sablon_Rehberi : Window
    {
        public Frm_Sablon_Rehberi()
        {
            InitializeComponent();
        }
        ...
        private void btn_stok_listele_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                depoCollection = depo.GetSablonKod(constraintPairs);
