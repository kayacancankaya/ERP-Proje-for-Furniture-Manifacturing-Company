    ...
    public partial class Frm_Virman : Window
    {
        ...
        private void btn_virman_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                else dateToRecord = Convert.ToDateTime(dp_tarih.SelectedDate).ToString("yyyy-MM-dd");
                ...
                eskiStokKodu.HareketMiktar = Convert.ToSingle(txt_eski_miktar.Text, CultureInfo.InvariantCulture);
                ...
                yeniStokKodu.HareketMiktar = Convert.ToSingle(txt_yeni_miktar.Text, CultureInfo.InvariantCulture);
                ...
                Frm_Virman virman = new Frm_Virman();
                this.Close();
                virman.Show();
