...
namespace Layer_UI.Uretim
{
    ...
    /// </summary>
    public partial class Frm_Uretim_Kaydi_Geri_Al_Referans : Window
    {
        ...
        public Frm_Uretim_Kaydi_Geri_Al_Referans()
        {
        ...
        private void btn_listele_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                isemriCollection = isemri.PopulateUSKGeriAlList(restrictionPairs, true);
        ...
        private async void btn_usk_geri_al_clicked(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                variables.ResultInt = await isemri.USKGeriAlRefAsync(gerialCollection, true);
                ...
                Frm_Uretim_Kaydi_Geri_Al_Referans _frm = new();
                _frm.Show();
                this.Close();
            }
            catch
