...

{
    public class Cls_Sevk : Cls_Base, INotifyPropertyChanged
    {
        ...
        public int YuklemeSira { get; set; }
        ...
        public ObservableCollection<Cls_Sevk> PopulateSevkEmriOlusturulacakList_SSH(Dictionary<string, string> kisitPairs)
        {
            try
            {
                ...
                Variables.Query_ = "select * from vbvSevkEmriOlusturulacakSiparisler where stokKodu like 'ssh%' ";
                variables.Counter = 0;
        ...
        public ObservableCollection<Cls_Sevk> PopulateYuklenecekSevkEmirleri(Dictionary<string, string> kisitPairs)
        {
            try
            {

                ObservableCollection<Cls_Sevk> OrdersCollection = new();
                Variables.Query_ = "select * from vbvYuklenmemisSevkEmirleri where 1=1 ";
                variables.Counter = 0;


                if (!string.IsNullOrEmpty(kisitPairs["sevkemriNo"]))
                {
                    Variables.Query_ = Variables.Query_ + "and BELGENO like '%' + @sevkemriNo + '%' ";
                    variables.Counter++;
                }

                if (!string.IsNullOrEmpty(kisitPairs["siparisNo"]))
                {
                    Variables.Query_ = Variables.Query_ + "and SIPNO like '%' + @siparisNo + '%' ";
                    variables.Counter++;
                }
                if (!string.IsNullOrEmpty(kisitPairs["stokKodu"]))
                {
                ...
                if (!string.IsNullOrEmpty(kisitPairs["sevkemriNo"]))
                {
                    parameters[variables.Counter] = new SqlParameter("@sevkemriNo", SqlDbType.NVarChar, 15);
                    parameters[variables.Counter].Value = kisitPairs["sevkemriNo"];
                    variables.Counter++;
                }
                if (!string.IsNullOrEmpty(kisitPairs["siparisNo"]))
                {
                    ...
                    if (reader != null && reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            Cls_Sevk sevkItem = new Cls_Sevk
                            {
                                ...
                                SevkSira = Convert.ToInt32(reader[6]),
                                SiparisKodu = reader[1].ToString(),
                                SiparisSira = Convert.ToInt32(reader[2]),
                                CariKodu = reader[7].ToString(),
                                CariAdi = reader[8].ToString(),
                                UrunKodu = reader[3].ToString(),
                                UrunAdi = reader[4].ToString(),
                                AcikSevkMiktar = Convert.ToInt32(reader[5]),
                                YuklenecekMiktar = Convert.ToInt32(reader[5]),
                            };
                            temp_coll_sevk.Add(sevkItem);
                        }
                    }
        ...
        public ObservableCollection<Cls_Sevk> PopulateSevkEmriOlusturulacakList(Dictionary<string, string> kisitPairs)
        {
            try
            {
                ...
                ObservableCollection<Cls_Sevk> OrdersCollection = new();
                Variables.Query_ = "select * from vbvSevkEmriOlusturulacakSiparisler where 1=1 ";
                variables.Counter = 0;
        ...
        public ObservableCollection<Cls_Sevk> PopulateSevkGuncelleList()
        {
            try
            {
                Variables.Query_ = "select * from vbvSevkGuncelleMas";
                string formattedDate = string.Empty;
                reader = data.Select_Command_Data_Reader(Variables.Query_, Variables.Yil_);
        ...
        public ObservableCollection<Cls_Sevk> PopulateSevkGuncelleListSatir(string sevkEmriNo)
        {
            try
            {
				...
				Variables.Query_ = "select * from vbvSevkGuncelleSatir where belgeno=@sevkEmriNo";

                reader = data.Select_Command_Data_Reader_With_Parameters(Variables.Query_, Variables.Yil_, parameter);
        ...
        public ObservableCollection<Cls_Sevk> PopulatePopupToBeUpdatedSevkEmri(string sevkEmriNo)
        {
            try
            {
                Variables.Query_ = "select * from vbvYuklenmemisSevkSatirEkle where belgeno = @belgeno";
        ...
        try 
	    {
                Variables.Query_ = "select sevkEmrino,teslimCariKodu,teslimCari,sevkAciklama,kayitTarihi,kullaniciAdi,sum(sevkMiktar) as toplamMiktar " +
                ...
                {
                    Variables.Query_ += " and sevkEmriNo like '%' + @sevkNo + '%'";
                    variables.Counter++;
                }
                ...
                {
                    Variables.Query_ += " and teslimCari like '%' + @cariAdi + '%'";
                    variables.Counter++;
                }
                ...
                Variables.Query_ += " group by sevkEmrino,teslimCariKodu,teslimCari,sevkAciklama,kayitTarihi,kullaniciAdi";
															                            ...
															                            string sevkEmriNo)
		{
			try
			{
                ...
                Variables.Query_ = "select siparisNo,siparisSira,stokKodu,stokAdi,paketKodu,paketAdi,siparisMiktar," +
				...
				if (restrictionPairs.ContainsKey("@cariAdi"))
				{
					Variables.Query_ += " and teslimCariIsmi like '%' + @cariAdi + '%'";
					variables.Counter++;
				}
                                                                                       ...
                                                                                       ,int siparisSira)
		{
			try
			{
				Variables.Query_ = "select yuklemeEmriNo,yukKayitTarihi,yuklemeMiktar from vbvSevkDurumRapor where " +
				...
				Variables.Query_ += " and siparisNo = '" + siparisNo + "'";
        ...
        try 
	    {
				...
				{
					Variables.Query_ = "select satisCariKodu,satisCariIsmi,teslimCariKodu,teslimCariIsmi,SUM(toplamTutarTl) as tlTutar,sum(dovizTutarToplam) as dovizTutar, " +
                    ...
                    Variables.Query_ += " group by satisCariKodu,satisCariIsmi,teslimCariKodu,teslimCariIsmi,dovizTipi";

				    using (SqlDataReader reader = data.Select_Command_Data_Reader_With_Parameters(Variables.Query_, Variables.Yil_, parameters,"Ahşap"))
				    {
                ...
                {
                    Variables.Query_ = "select satisCariKodu,satisCariIsmi,teslimCariKodu,teslimCariIsmi,SUM(tlTutar) as tlTutar,sum(dovizTutar) as dovizTutar, " +
                                   " dovizTipi from vbvSevkRapor (nolock) group by satisCariKodu,satisCariIsmi,teslimCariKodu,teslimCariIsmi,dovizTipi";


					temp_coll_sevk.Clear();
					SevkCollectionCariReport.Clear();
					using (SqlDataReader reader = data.Select_Command_Data_Reader(Variables.Query_, Variables.Yil_,"Ahşap"))
					{
        ...
        try 
	    {
                ...
                else
                {
					...
					temp_coll_sevk.Clear();
					SevkCollectionCariReport.Clear();
					using (SqlDataReader reader = data.Select_Command_Data_Reader(Variables.Query_, Variables.Yil_))
					{
			...
			try 
	    {
                ...
                Variables.Query_ = "select siparisNo, SUM(toplamTutarTl) as tlTutar,sum(dovizTutarToplam) as dovizTutar,  dovizTipi, destinasyon,poNo " +
                ...
                Variables.Query_ += " group by siparisNo, destinasyon, poNo, dovizTipi";
			...
			try 
	    {
                ...
                Variables.Query_ = "select siparisNo, SUM(tlTutar) as tlTutar,sum(dovizTutar) as dovizTutar,  dovizTipi, destinasyon,poNo " +
                                   " from vbvSevkRapor(nolock)  where 1 = 1 " + restrictionQueries + " and satisCariKodu = '" + satisCariKodu + "' and " +
                                   " satisCariIsmi = '" + satisCariAdi + "' and teslimCariKodu = '" + teslimCariKodu + "' and teslimCariIsmi ='" + teslimCariAdi + "' ";
                                                                             ...
                                                                             string siparisNo,string fabrika)
		{
			try
			{
				Variables.Query_ = "select * from vbvSevkRapor where 1 = 1" + restrictionQueries;
				variables.Counter = 0;
				...
				using (SqlDataReader reader = data.Select_Command_Data_Reader_With_Parameters(Variables.Query_, Variables.Yil_, parameters,fabrika))
				{
					...
					while (reader.Read())
					{
						Cls_Sevk sevkItem = new Cls_Sevk
						{
							...
							TlTutarToplamSiparis = Convert.ToSingle(reader["toplamTutarTl"]),
							DovizTutarToplamSiparis = Convert.ToSingle(reader["dovizTutarToplam"]),
							DovizTipi = (Cls_Base.DovizTipi)Convert.ToInt32(reader["dovizTipi"]),
							Destinasyon = reader["destinasyon"].ToString(),
							PONo = reader["poNo"].ToString(),
		...
		public ObservableCollection<Cls_Sevk> PopulateInvoiceCollection(string siparisNo,string fabrika)
		{
			try
			{
				Variables.Query_ = "select * from vbvCariRaporExcelAktar where siparisNo = @siparisNo";
		...
		public ObservableCollection<Cls_Sevk> GetProductVolumeAndWeight(string productCode, string fabrika)
        {
            try
            {
                ...
                Variables.Query_ = "select * from vbvUrunHacimAgirlikBilgisiGetir where stok_kodu=@urunKodu";
                SqlParameter[] parameters = new SqlParameter[1];
        ...
        public ObservableCollection<Cls_Sevk> GetExcelReportCollectionForUrunToplama(string sevkEmriNo)
        {
            try
            {
                Variables.Query_ = "select distinct sevkEmriNo, kayitTarihi,stokKodu,stokAdi,paketKodu,paketAdi,sevkAciklama,sevkMiktar" +
        ...
        public bool InsertShipmentsOrder(ObservableCollection<Cls_Sevk> shipments)
        {
            try
            {
                ...
                SevkEmriNo = data.Get_One_String_Result_Stored_Proc_With_Parameters("vbpGetFisno", Variables.Yil_, parameter);
                ...
                variables.Result = data.ExecuteStoredProcedureWithParameters("vbpInsertSevkEmriGenel", Variables.Yil_, parameters);
                ...
                foreach (Cls_Sevk item in shipments)
                {
                    ...
                    variables.Result = data.ExecuteStoredProcedureWithParameters("vbpInsertSevkEmriSatir", Variables.Yil_, parametersForRows);
        ...
        public string InsertShipments(ObservableCollection<Cls_Sevk> shipments)
        {
            try
            {
                //sevk emri no al
                ...
                //sevk irsaliye no al
                SevkIrsaliyeNo = data.Get_One_String_Result_Stored_Proc("vbpGetSevkIrsaliyeNo", Variables.Yil_);
                ...
                //satış cari kodu al
                Variables.Query_ = "Select STHAR_ACIKLAMA from tblsipatra where fisno=@fisno and stra_sipkont=@sira and stok_kodu=@stokKodu";
                ...
                reader = data.Select_Command_Data_Reader_With_Parameters(Variables.Query_, Variables.Yil_, parametersForSatisCari);
                ...
                variables.Result = data.ExecuteStoredProcedureWithParameters("vbpYuklemeKayitMas", Variables.Yil_, parametersYuklemeMas);
                if (!variables.Result)
                ...
                foreach (Cls_Sevk item in shipments)
                {
                    SqlParameter[] parametersYuklemeSatir = new SqlParameter[10];
                    ...
                    parametersYuklemeSatir[4] = new SqlParameter("@sevkEmriSira", SqlDbType.TinyInt);
                    parametersYuklemeSatir[4].Value = item.SevkSira;
                    parametersYuklemeSatir[5] = new SqlParameter("@sira", SqlDbType.TinyInt);
                    parametersYuklemeSatir[5].Value = variables.Counter;
                    parametersYuklemeSatir[6] = new SqlParameter("@miktar", SqlDbType.Int);
                    parametersYuklemeSatir[6].Value = item.SevkMiktar;
                    parametersYuklemeSatir[7] = new SqlParameter("@stokKodu", SqlDbType.NVarChar, 35);
                    parametersYuklemeSatir[7].Value = item.UrunKodu;
                    parametersYuklemeSatir[8] = new SqlParameter("@userId", SqlDbType.NVarChar, 5);
                    parametersYuklemeSatir[8].Value = user;
                    parametersYuklemeSatir[9] = new SqlParameter("@sevkIrsaliyeNo", SqlDbType.NVarChar, 15);
                    parametersYuklemeSatir[9].Value = SevkIrsaliyeNo;

                    variables.Result = data.ExecuteStoredProcedureWithParameters("vbpYuklemeKayitSatir", Variables.Yil_, parametersYuklemeSatir);
                    if (!variables.Result)
                ...
                variables.Result = data.ExecuteStoredProcedureWithParameters("vbpElTerminaliIrsaliyeKaydet", Variables.Yil_, parametersIrsaliye);
                if (!variables.Result)
		...
		public bool InsertShipmentsToExistingOrder(ObservableCollection<Cls_Sevk> shipments)
		{
			try
			{
                ...
                Variables.Query_ = "select sira,sipno,sipkont,belgeno from tblsevktra where belgeno=@sevkEmriNo order by inckeyno asc";
                reader = data.Select_Command_Data_Reader_With_Parameters(Variables.Query_,Variables.Yil_,parametersSiraOrder);
                ...
                while(reader.Read())
                {
					...
					Variables.Query_ = "UPDATE tblsevktra SET sira = @sira WHERE sipno = @sipno AND sipkont = @sipkont AND belgeno = @belgeno";

					variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parametersUpdate);
		...
		public bool UpdateYuklenmemisSevkMiktar(string sevkEmriNo, string siparisNo, int siparisSira, int sevkMiktar)
        {
            try
            {
                ...
                Variables.Query_ = "update TBLSEVKTRA SET MIKTAR=@sevkMiktar where BELGENO=@sevkEmriNo and SIPNO=@siparisNo and sipkont=@siparisSira";

                variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parameters);
                ...
                Variables.Query_ = "select f_yedek1,f_yedek2,miktar from tblsevktra where belgeno=@sevkEmriNo";
                ...
                Variables.Query_ = "update tblsevkmas set f_yedek1 = @toplamHacim, f_yedek2 = @toplamAgirlik where belgeno=@sevkEmriNo";

				variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parametermas);
				if (!variables.Result) return false;
        ...
        public bool UpdateSevkMas(ObservableCollection<Cls_Sevk> shipments)
        {
            try
            {
				...
				Variables.Query_ = "update tblsevkmas set tarih=@sevkEmriTarihi, acik1=@SevkAciklama,kamyonno=@plakaNo,duzeltmeyapankul=@userID, " +
        ...
        public ObservableCollection<Cls_Sevk> UpdateSevkSira(ObservableCollection<Cls_Sevk> reOrderedSevkSira)
        {
            try
            {
                ...
                foreach (Cls_Sevk item in reOrderedSevkSira)
                {
                    ...
                    Variables.Query_ = "update tblsevktra set sira = @sevkSira where belgeno = @sevkEmriNo " +
                                      "and sipno = @siparisKodu and sipkont = @siparisSira";

                    variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parameter);
		...
		private ObservableCollection<Cls_Sevk> GetReorderedSevkSira(ObservableCollection<Cls_Sevk> reorderedSevkSira)
		{
			try
			{
				...
				Variables.Query_ = "select * from vbvSevkSiraDuzenle where belgeno=@sevkEmriNo";
        ...
        private int CountSevkSira(string sevkEmriNo)
        {
            try
            {
                ...
                Variables.Query_ = "select count(*) from tblsevktra where belgeno=@sevkEmriNo";
		...
		public bool DeleteYuklenmemisSevkEmriMas(string sevkEmriNo)
        {
            try
            {
                ...
                variables.Result = data.ExecuteStoredProcedureWithParameters("vbpDeleteYuklenmemisSevkEmriMas", Variables.Yil_, parameter);
                if (!variables.Result) return false;
        ...
        public bool DeleteYuklenmemisSevkSatir(string sevkEmriNo, string siparisNo, int siparisSira)
        {
            try
            {
                ...
                variables.Result = data.ExecuteStoredProcedureWithParameters("vbpDeleteYuklenmemisSevkEmriSatir", Variables.Yil_, parameters);
        ...
        public bool DeleteYuklemeKaydiGeriAl(ObservableCollection<Cls_Sevk> shipmentCollection, string result)
        {
            try 
            {
                ...
                { 
                    Variables.Query_ = "delete from tblsevkmas where tip=1 and belgeno=@belgeno";
                    SqlParameter[] parameter = new SqlParameter[1];
                    parameter[0] = new SqlParameter("@belgeno", SqlDbType.NVarChar, 15);
                    parameter[0].Value = SevkEmriNo;
                    variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parameter);
                ...
                { 
                    Variables.Query_ = "delete from tblsevkmas where tip=1 and belgeno=@belgeno delete from tblsevktra where tip=1 and belgeno=@belgeno";
                    SqlParameter[] parameter = new SqlParameter[1];
                    parameter[0] = new SqlParameter("@belgeno", SqlDbType.NVarChar, 15);
                    parameter[0].Value = SevkEmriNo;
                    variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parameter);
                    ...
                    result == "Sevk Genel Bilgileri Kaydedilirken")
                {
					...
					foreach (Cls_Sevk item in shipmentCollection)
					{
                        ...
                        //sevk irsaliye no al
						Variables.Query_ = "Select fisno from tblsthar where stok_kodu=@stokKodu and sthar_sipnum=@fisno and stra_sipkont=@stra_sipkont";
						...
						SevkIrsaliyeNo = data.Get_One_String_Result_Command_With_Parameters(Variables.Query_, Variables.Yil_, parameterSthar);

                        if (string.IsNullOrEmpty(SevkIrsaliyeNo))
                            return true;

                        //sthar sil
                        Variables.Query_ = " delete from tblsthar where stok_kodu=@stokKodu and sthar_sipnum=@siparisNo and stra_sipkont=@stra_sipkont " +
                                          " fisno =@fisno"  ;
						...
						variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parameterForDeleteSthar);
						...
						Variables.Query_ = "Select inckeyno from tblsthar where stok_kodu=@stokKodu and sthar_sipnum=@sipNo and stra_sipkont=@stra_sipkont" +
										  " fisno =@fisno";
						...
						inckeyno = data.Get_One_String_Result_Command_With_Parameters(Variables.Query_, Variables.Yil_, parameterInckey);
						...
						//kalem sil
						Variables.Query_ = " delete from TBLKALEMDETAY where refinckeyno=@inckey";
						...
						variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parameterForDeleteKalem);

						if (!variables.Result)
							return false;
                        //yukleme isemri no al
                        Variables.Query_ = "select isemrino from tblisemri where siparis_no=@sipno and sipkont=@sipkont and stok_kodu=@stokKodu and isemrino like 'YUK%'";
						...
						YuklemeEmriNo = data.Get_One_String_Result_Command_With_Parameters(Variables.Query_, Variables.Yil_, parameterInckey);
                        if (string.IsNullOrEmpty(YuklemeEmriNo))
                            return true;

						//yukleme satir sil
						Variables.Query_ = "delete from sbpturetimsonu where isEmriNo=@isemrino and stokKodu=@stokKodu " +
						...
						variables.Result = data.ExecuteCommandWithParameters(Variables.Query_, Variables.Yil_, parameterForDeleteYukSatir);
		...
		private int CheckIfSevkSatirExists(string sevkEmriNo, string siparisNo, int siparisSatir)
        {
            try
            {
                ...
                Variables.Query_ = "Select count(*) from tblsevktra where belgeno=@sevkEmriNo and sipno=@siparisNo and sipkont=@siparisSatir";
                reader = data.Select_Command_Data_Reader_With_Parameters(Variables.Query_, Variables.Yil_,parameters);
